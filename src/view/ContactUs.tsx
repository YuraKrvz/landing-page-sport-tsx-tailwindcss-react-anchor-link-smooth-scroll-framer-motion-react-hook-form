            ...
            >
              ...
              {errors.name && (
                <p className='mt-1 text-primary-500 '>
                  {errors.name.type === 'required' && 'This field if required'}
                  {errors.name.type === 'maxLength' && 'This field has max length is 100'}
                </p>
              )}
              ...
              {errors.email && (
                <p className='mt-1 text-primary-500 '>
                  {errors.email.type === 'required' && 'This field if required'}
                  {errors.email.type === 'pattern' && 'Email address invalid'}
                </p>
              )}
              ...
              {errors.message && (
                <p className='mt-1 text-primary-500 '>
                  {errors.message.type === 'required' && 'This field if required'}
                  {errors.message.type === 'maxLength' && 'This field has max length is 400'}
                </p>
              )}
